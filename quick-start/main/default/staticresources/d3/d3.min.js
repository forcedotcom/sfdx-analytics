...
!(function (t, n) {
  ...
  ((t.event = null), 'undefined' != typeof document) &&
    ('onmouseenter' in document.documentElement || (Mt = { mouseenter: 'mouseover', mouseleave: 'mouseout' }));
  function Nt(t, n, e) {
    return (
      (t = Tt(t, n, e)),
      function (n) {
      ...
      (n = rn.exec(t))
        ? ((e = n[1].length),
          ...
          6 === e
            ? vn(n)
            : 3 === e
            ? new bn(((n >> 8) & 15) | ((n >> 4) & 240), ((n >> 4) & 15) | (240 & n), ((15 & n) << 4) | (15 & n), 1)
            : 8 === e
            ? gn((n >> 24) & 255, (n >> 16) & 255, (n >> 8) & 255, (255 & n) / 255)
            : 4 === e
            ? gn(
                ((n >> 12) & 15) | ((n >> 8) & 240),
                ((n >> 8) & 15) | ((n >> 4) & 240),
  ...
  Qt(Jt, pn, {
    ...
    Qt(
      ...
      Kt(Jt, {
        brighter: function (t) {
          return (
            (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new bn(this.r * t, this.g * t, this.b * t, this.opacity)
          );
        },
        darker: function (t) {
          return (t = null == t ? 0.7 : Math.pow(0.7, t)), new bn(this.r * t, this.g * t, this.b * t, this.opacity);
        },
        rgb: function () {
          return this;
        },
    ...
    Qt(
      ...
      Kt(Jt, {
        brighter: function (t) {
          return (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new An(this.h, this.s, this.l * t, this.opacity);
        },
        darker: function (t) {
          return (t = null == t ? 0.7 : Math.pow(0.7, t)), new An(this.h, this.s, this.l * t, this.opacity);
        },
        rgb: function () {
  ...
  Qt(
    ...
    Kt(Jt, {
      ...
      rgb: function () {
        ...
        return new bn(
          In(3.1338561 * (n = Cn * Yn(n)) - 1.6168667 * (t = Pn * Yn(t)) - 0.4906146 * (e = zn * Yn(e))),
  ...
  Qt(
    ...
    Kt(Jt, {
      brighter: function (t) {
        return (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new re(this.h, this.s, this.l * t, this.opacity);
      },
      darker: function (t) {
        return (t = null == t ? 0.7 : Math.pow(0.7, t)), new re(this.h, this.s, this.l * t, this.opacity);
      },
      rgb: function () {
  ...
  function Re(t, n, e, r, i, o) {
    ...
    return (
      ...
      { translateX: i, translateY: o, rotate: Math.atan2(n, t) * Pe, skewX: Math.atan(c) * Pe, scaleX: a, scaleY: u }
    );
  }
  function De(t, n, e, r) {
    function i(t) {
  ...
  var qe = De(
      function (t) {
        return 'none' === t
          ? ze
          : (Se || ((Se = document.createElement('DIV')), (ke = document.documentElement), (Ee = document.defaultView)),
        ...
        (function () {
          ...
          for (; e; )
            e._call
              ...
              : ((n = e._next), (e._next = null), (e = t ? (t._next = n) : (Ke = n)));
          (Je = t), gr(r);
        })(),
        (or = 0);
    }
  ...
  function gr(t) {
    tr ||
      ...
      t - or > 24
        ? (t < 1 / 0 && (nr = setTimeout(pr, t - ur.now() - ar)), er && (er = clearInterval(er)))
        : (er || ((ir = ur.now()), (er = setInterval(vr, rr))), (tr = 1), cr(pr)));
  }
  function yr(t, n, e) {
    var r = new lr();
    return (
  ...
  lr.prototype = hr.prototype = {
    ...
    restart: function (t, n, e) {
      ...
      (e = (null == e ? fr() : +e) + (null == n ? 0 : +n)),
        this._next || Je === this || (Je ? (Je._next = this) : (Ke = this), (Je = this)),
        (this._call = t),
        (this._time = e),
        gr();
    },
  ...
  function Sr(t, n, e, r, i, o) {
    ...
    !(function (t, n, e) {
      ...
      function o(c) {
        ...
        for (f in i)
          if ((h = i[f]).name === e.name) {
            ...
            h.state === Nr
              ? ((h.state = Ar), h.timer.stop(), h.on.call('interrupt', t, t.__data__, h.index, h.group), delete i[f])
              : +f < n &&
                ((h.state = Ar), h.timer.stop(), h.on.call('cancel', t, t.__data__, h.index, h.group), delete i[f]);
          }
        if (
          (yr(function () {
      ...
      function a(n) {
        for (
          var i = n < e.duration ? e.ease.call(null, n / e.duration) : (e.timer.restart(u), (e.state = Tr), 1),
            o = -1,
            a = r.length;
          ++o < a;
      ...
      for (var r = this._groups, i = r.length, o = new Array(i), a = 0; a < i; ++a)
        for (var u, c, f = r[a], s = f.length, l = (o[a] = new Array(s)), h = 0; h < s; ++h)
          (u = f[h]) &&
            ...
            ('__data__' in u && (c.__data__ = u.__data__), (l[h] = c), Sr(l[h], n, e, h, l, Cr(u, e)));
            ...
            (function (t, n, e) {
              ...
              return function () {
                var a = ft(this, t),
                  ...
                  c = u + '';
                return (
                  null == u && (this.style.removeProperty(t), (c = u = ft(this, t))),
    ...
    function d() {
            ...
            F.on(
              ...
              function () {
                switch (t.event.keyCode) {
                  ...
                  case 18:
                    x === Ni &&
                      (w && ((f = h - P * w), (r = o + P * w)), M && ((d = p - z * M), (u = c + z * M)), (x = Ti), I());
                    break;
                  case 32:
                    (x !== Ni && x !== Ti) ||
                      (w < 0 ? (f = h - P) : w > 0 && (r = o - P),
              ...
              function () {
                switch (t.event.keyCode) {
                  ...
                  case 32:
                    x === Mi &&
                      (t.event.altKey
                        ? (w && ((f = h - P * w), (r = o + P * w)), M && ((d = p - z * M), (u = c + z * M)), (x = Ti))
                        : (w < 0 ? (f = h) : w > 0 && (r = o), M < 0 ? (d = p) : M > 0 && (u = c), (x = Ni)),
                      B.attr('cursor', Pi[m]),
                      I());
                    break;
                  default:
      ...
      function I() {
        ...
        switch (((P = L[0] - q[0]), (z = L[1] - q[1]), x)) {
          case Mi:
          case wi:
            w && ((P = Math.max(S - r, Math.min(E - f, P))), (o = r + P), (h = f + P)),
              M && ((z = Math.max(k - u, Math.min(C - d, z))), (c = u + z), (p = d + z));
            break;
          case Ni:
            w < 0
              ? ((P = Math.max(S - r, Math.min(E - r, P))), (o = r + P), (h = f))
              : w > 0 && ((P = Math.max(S - f, Math.min(E - f, P))), (o = r), (h = f + P)),
              M < 0
                ? ((z = Math.max(k - u, Math.min(C - u, z))), (c = u + z), (p = d))
                : M > 0 && ((z = Math.max(k - d, Math.min(C - d, z))), (c = u), (p = d + z));
            break;
          case Ti:
            w && ((o = Math.max(S, Math.min(E, r - P * w))), (h = Math.max(S, Math.min(E, f + P * w)))),
              M && ((c = Math.max(k, Math.min(C, u - z * M))), (p = Math.max(k, Math.min(C, d + z * M))));
        }
        h < o &&
          ((w *= -1),
          (t = r),
  ...
  function Bo(t) {
    ...
    return isNaN(t)
      ...
      : (function (t) {
          ...
          Oo(t.getUTCDate(), 2) +
          (i
            ? 'T' + Oo(n, 2) + ':' + Oo(e, 2) + ':' + Oo(r, 2) + '.' + Oo(i, 3) + 'Z'
            : r
  ...
  (Ta.copy = function () {
    ...
    for (t = [{ source: r, target: (e._root = new Array(4)) }]; (r = t.pop()); )
      for (var i = 0; i < 4; ++i)
        (n = r.source[i]) &&
          (n.length ? t.push({ source: n, target: (r.target[i] = new Array(4)) }) : (r.target[i] = Na(n)));
    return e;
  }),
    (Ta.add = function (t) {
  ...
  function Va(t) {
    ...
    function l(t) {
      var n = (t = Oa(t)).fill,
        ...
        y = t.trim,
        _ = t.type;
      'n' === _ ? ((v = !0), (_ = 'g')) : Ya[_] || (void 0 === g && (g = 12), (y = !0), (_ = 'g')),
        (d || ('0' === n && '=' === e)) && ((d = !0), (n = '0'), (e = '='));
      ...
      return (
        (g = void 0 === g ? 6 : /[gprs]/.test(_) ? Math.max(1, Math.min(21, g)) : Math.max(0, Math.min(20, g))),
        (M.toString = function () {
          return t + '';
        }),
        M
    ...
    Mc = {
      ...
      polygonEnd: function () {
        Ou.polygonEnd(),
          ...
          (Mc.lineStart = Ac),
          (Mc.lineEnd = Sc),
          Lu < 0 ? ((Zu = -(Ku = 180)), (Qu = -(Ju = 90))) : wc > nu ? (Ju = 90) : wc < -nu && (Qu = -90),
          (oc[0] = Zu),
          (oc[1] = Ku);
      },
      sphere: function () {
  ...
  function Bc(t, n) {
    ...
    var e = hu((n *= cu)),
      ...
      o = yu(n),
      a = lu(
        bu((a = mc * o - xc * i) * a + (a = xc * r - bc * o) * a + (a = bc * i - mc * r) * a),
        bc * r + mc * i + xc * o
      );
  ...
  function Jc(t, n, e, r, i, o) {
    if (e) {
      ...
      null == i
        ? ((i = n + r * au), (o = n - c / 2))
        : ((i = tf(a, i)), (o = tf(a, o)), (r > 0 ? i < o : i > o) && (i += r * au));
  ...
  function ff(t, n) {
    ...
    for (var c = 0, f = t.length; c < f; ++c)
      if ((l = (s = t[c]).length))
        for (
          var s, l, h = s[l - 1], d = cf(h), p = h[1] / 2 + ou, v = yu(p), g = hu(p), y = 0;
          y < l;
          ++y, d = b, v = x, g = w, h = _
        ) {
          var _ = s[y],
            ...
            : i !== u &&
              ...
              (r = (function (t, n, e, r) {
                var i,
                  ...
                  a = yu(t - e);
                return fu(a) > nu
                  ? su((yu(n) * (o = hu(r)) * yu(e) - yu(r) * (i = hu(n)) * yu(t)) / (i * o * a))
                  : (n + r) / 2;
              })(e, r, o, a)),
              t.point(i, r),
              t.lineEnd(),
      ...
      function (t) {
        ...
        return {
          ...
          point: function (l, h) {
            ...
            if (
              (!n && (f = c = v) && t.lineStart(),
              v !== c && (!(d = a(n, p)) || ef(n, d) || ef(p, d)) && ((p[0] += nu), (p[1] += nu), (v = o(p[0], p[1]))),
              v !== c)
            )
              (s = 0),
                v
  ...
  function Ff() {
    ...
    return (
      ...
      (_.precision = function (h) {
        return arguments.length
          ? ((y = +h), (c = Of(o, i, 90)), (f = Bf(n, t, y)), (s = Of(u, a, 90)), (l = Bf(r, e, y)), _)
          : y;
      }),
      _.extentMajor([
        [-180, -90 + nu],
          ...
          function e(r, i, o, a, u, c, f, s, l, h, d, p, v, g) {
            ...
            if (b > 4 * n && v--) {
              var m = a + h,
                ...
                C = k - i,
                P = _ * E - y * C;
              ((P * P) / b > n || fu((y * E + _ * C) / b - 0.5) > 0.3 || a * h + u * d + c * p < Gs) &&
  ...
  function Ks(t) {
    ...
    return (
      ...
      (S.clipExtent = function (t) {
        return arguments.length
          ? ((T =
              null == t
                ? ((N = r = i = o = null), Yf)
                : yf((N = +t[0][0]), (r = +t[0][1]), (i = +t[1][0]), (o = +t[1][1]))),
            C())
          : null == N
          ? null
          : [
      ...
      (S.rotate = function (t) {
        return arguments.length
          ? ((g = (t[0] % 360) * cu), (y = (t[1] % 360) * cu), (_ = t.length > 2 ? (t[2] % 360) * cu : 0), E())
          : [g * uu, y * uu, _ * uu];
      }),
      (S.angle = function (t) {
  ...
  function el() {
    return nl().parallels([29.5, 45.5]).scale(1070).translate([480, 250]).rotate([96, 0]).center([-0.6, 38.7]);
  }
  function rl(t) {
    return function (n, e) {
      var r = hu(n),
    ...
    for (null == n && (n = El); (e = f.pop()); )
      if ((c && (e.value = +e.data.value), (i = n(e.data)) && (a = i.length)))
        for (e.children = new Array(a), o = a - 1; o >= 0; --o)
          f.push((r = e.children[o] = new zl(i[o]))), (r.parent = e), (r.depth = e.depth + 1);
  ...
  (_l.invert = function (t, n) {
    for (
      ...
      ((o =
        (i =
          (r -= e = (r * (dl + pl * i + o * (vl + gl * i)) - n) / (dl + 3 * pl * i + o * (7 * vl + 9 * gl * i))) * r) *
        i *
        i),
      !(fu(e) < eu));
      ++a
  ...
  function Vl(t) {
    ...
    t: for (u = 3; u < i; ++u) {
      ...
      for (r.previous = n, r.next = e, n.next = e.previous = e = r, o = jl(n); (r = r.next) !== e; )
        (a = jl(r)) < o && ((n = r), (o = a));
      e = n.next;
    }
  ...
  function jv(t, n, r, i, o, a, u, c, f) {
    ...
    function M(e) {
      return (
        u(e) < e ? d : a(e) < e ? p : o(e) < e ? v : i(e) < e ? g : n(e) < e ? (r(e) < e ? y : _) : t(e) < e ? b : m
      )(e);
    }
    function N(n, r, i, o) {
    ...
    return (
      ...
      (s.ticks = function (t, n) {
        var e,
          ...
          a = o < i;
        return (
          a && ((e = i), (i = o), (o = e)), (e = (e = N(t, i, o, n)) ? e.range(i, o + 1) : []), a ? e.reverse() : e
        );
      }),
  ...
  function Oy(t, n, e, r, i, o, a) {
    ...
    return (
      ...
      { cx: N, cy: T, x01: -s, y01: -l, x11: N * (i / x - 1), y11: T * (i / x - 1) }
    );
  }
  function By(t) {
    this._context = t;
  ...
  function G_(t, n, e) {
    var r = t._x1 - t._x0,
      ...
      a = (e - t._y1) / (i || (r < 0 && -0)),
      u = (o * i + a * r) / (r + i);
    return (V_(o) + V_(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) || 0;
  }
  function $_(t, n) {
    var e = t._x1 - t._x0;
    ...
    (hb.prototype = {
      ...
      insert: function (t, n) {
        ...
        if (t) {
          ...
          this._
            ? ((t = gb(this._)), (n.P = null), (n.N = t), (t.P = t.L = n), (e = t))
            : ((n.P = n.N = null), (this._ = n), (e = null));
        for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C; )
          e === (r = e.U).L
            ? (i = r.R) && i.C
              ? ((e.C = i.C = !1), (r.C = !0), (t = r))
              : (t === e.R && (pb(this, e), (e = (t = e).U)), (e.C = !1), (r.C = !0), vb(this, r))
            : (i = r.L) && i.C
            ? ((e.C = i.C = !1), (r.C = !0), (t = r))
            : (t === e.L && (vb(this, e), (e = (t = e).U)), (e.C = !1), (r.C = !0), pb(this, r)),
            (e = t.U);
        this._.C = !1;
      },
      remove: function (t) {
        ...
        if (
          ...
          if (t && t.C) t.C = !1;
            ...
            do {
              ...
              if (t === i.L) {
                if (
                  ((n = i.R).C && ((n.C = !1), (i.C = !0), pb(this, i), (n = i.R)), (n.L && n.L.C) || (n.R && n.R.C))
                ) {
                  (n.R && n.R.C) || ((n.L.C = !1), (n.C = !0), vb(this, n), (n = i.R)),
                    (n.C = i.C),
                    (i.C = n.R.C = !1),
                    pb(this, i),
                    (t = this._);
                ...
                ((n = i.L).C && ((n.C = !1), (i.C = !0), vb(this, i), (n = i.L)), (n.L && n.L.C) || (n.R && n.R.C))
              ) {
                (n.L && n.L.C) || ((n.R.C = !1), (n.C = !0), pb(this, n), (n = i.L)),
                  (n.C = i.C),
                  (i.C = n.L.C = !1),
                  vb(this, i),
                  (t = this._);
  ...
  function qb(t) {
    ...
    if ((Ob.insert(n, c), n || e)) {
      if (n === e)
        return Eb(n), (e = zb(n.site)), Ob.insert(c, e), (c.edge = e.edge = yb(n.site, c.site)), kb(n), void kb(e);
      if (e) {
        Eb(n), Eb(e);
        var f = n.site,
          s = f[0],
  ...
  function Vb(t, n) {
    ...
    for (Yb = [], Bb = new Array(t.length), Ob = new hb(), Fb = new hb(); ; )
      if (((i = Tb), o && (!i || o[1] < i.y || (o[1] === i.y && o[0] < i.x))))
        (o[0] === e && o[1] === r) || (qb(o), (e = o[0]), (r = o[1])), (o = t.pop());
      else {
        if (!i) break;
        Db(i.arc);
      }
    if (
      ...
      !(function (t, n, e, r) {
        for (var i, o = Yb.length; o--; )
          (xb((i = Yb[o]), t, n, e, r) &&
            mb(i, t, n, e, r) &&
            (Math.abs(i[0][0] - i[1][0]) > Ib || Math.abs(i[0][1] - i[1][1]) > Ib)) ||
            delete Yb[o];
      })(a, u, c, f),
        (function (t, n, e, r) {
          var i,
          ...
          if (y) {
            ...
            for (i = 0, y = null; i < g; ++i)
              (o = Bb[i]) && (m = (_ = (a = o.site)[0] - t) * _ + (b = a[1] - n) * b) < x && ((x = m), (y = o));
            if (y) {
              var w = [t, n],
                M = [t, r],
                N = [e, r],
  ...
  function rm() {
    return -t.event.deltaY * (1 === t.event.deltaMode ? 0.05 : t.event.deltaMode ? 1 : 0.002);
  }
  function im() {
    return navigator.maxTouchPoints || 'ontouchstart' in this;
  }
  ...
  (Qb.prototype = Wb.prototype),
        ...
        if ((u || (u = c = no()), l < s && ((f = l), (l = s), (s = f)), l > ky))
          if (p > Py - ky)
            u.moveTo(l * My(h), l * Ay(h)),
              u.arc(0, 0, l, h, d, !v),
              s > ky && (u.moveTo(s * My(d), s * Ay(d)), u.arc(0, 0, s, d, h, v));
          else {
            var g,
              y,
              _ = h,
            ...
            if (T > ky) {
              var E = zy((T / s) * Ay(N)),
                C = zy((T / l) * Ay(N));
              (w -= 2 * E) > ky ? ((m += E *= v ? 1 : -1), (x -= E)) : ((w = 0), (m = x = (h + d) / 2)),
                (M -= 2 * C) > ky ? ((_ += C *= v ? 1 : -1), (b -= C)) : ((M = 0), (_ = b = (h + d) / 2));
            }
            var P = l * My(_),
              z = l * Ay(_),
              R = s * My(x),
            ...
            M > ky
              ? k > ky
                ? ((g = Oy(O, B, P, z, l, k, v)),
                  ...
                  k < A
                    ? u.arc(g.cx, g.cy, k, wy(g.y01, g.x01), wy(y.y01, y.x01), !v)
                    : (u.arc(g.cx, g.cy, k, wy(g.y01, g.x01), wy(g.y11, g.x11), !v),
                      u.arc(0, 0, l, wy(g.cy + g.y11, g.cx + g.x11), wy(y.cy + y.y11, y.cx + y.x11), !v),
                      u.arc(y.cx, y.cy, k, wy(y.y11, y.x11), wy(y.y01, y.x01), !v)))
              ...
              s > ky && w > ky
                ? S > ky
                  ? ((g = Oy(R, D, L, U, s, -S, v)),
                    ...
                    S < A
                      ? u.arc(g.cx, g.cy, S, wy(g.y01, g.x01), wy(y.y01, y.x01), !v)
                      : (u.arc(g.cx, g.cy, S, wy(g.y01, g.x01), wy(g.y11, g.x11), !v),
                        u.arc(0, 0, s, wy(g.cy + g.y11, g.cx + g.x11), wy(y.cy + y.y11, y.cx + y.x11), v),
                        u.arc(y.cx, y.cy, S, wy(y.y11, y.x11), wy(y.y01, y.x01), !v)))
                  : u.arc(0, 0, s, x, m, v)
                : u.lineTo(R, D);
          }
        else u.moveTo(0, 0);
    ...
    (t.contourDensity = function () {
      ...
      function l(r) {
        ...
        r.forEach(function (r, o, s) {
          ...
          Ao({ width: c, height: f, data: i }, { width: c, height: f, data: l }, o >> a),
          So({ width: c, height: f, data: l }, { width: c, height: f, data: i }, o >> a),
          Ao({ width: c, height: f, data: i }, { width: c, height: f, data: l }, o >> a),
          So({ width: c, height: f, data: l }, { width: c, height: f, data: i }, o >> a),
          Ao({ width: c, height: f, data: i }, { width: c, height: f, data: l }, o >> a),
          So({ width: c, height: f, data: l }, { width: c, height: f, data: i }, o >> a);
      ...
      return (
        ...
        (l.thresholds = function (t) {
          return arguments.length
            ? ((s = 'function' == typeof t ? t : Array.isArray(t) ? bo(yo.call(t)) : bo(t)), l)
            : s;
        }),
    ...
    (t.drag = function () {
      ...
      function p() {
        if (!i && o.apply(this, arguments)) {
          ...
          u &&
            (Rt(t.event.view).on('mousemove.drag', v, !0).on('mouseup.drag', g, !0),
            Ht(t.event.view),
            Yt(),
            (r = !1),
            (n = t.event.clientX),
      ...
      function m(n, e, r, i, o) {
        var a,
          ...
          v = s.copy();
        if (
          kt(new Vt(d, 'beforestart', a, n, l, p[0], p[1], 0, 0, v), function () {
    ...
    (t.forceManyBody = function () {
      ...
      function l(t, i, c, f) {
        ...
        if (!(t.length || d >= a)) {
          (t.data !== n || t.next) &&
            (0 === s && (d += (s = ya()) * s), 0 === l && (d += (l = ya()) * l), d < o && (d = Math.sqrt(o * d)));
          do {
      ...
      if (((Ju = Ku = -(Zu = Qu = 1 / 0)), (ic = []), Cu(t, Mc), (e = ic.length))) {
        for (ic.sort(zc), n = 1, o = [(r = ic[0])]; n < e; ++n)
          Rc(r, (i = ic[n])[0]) || Rc(r, i[1])
            ? (Pc(r[0], i[1]) > Pc(r[0], r[1]) && (r[1] = i[1]), Pc(i[0], r[1]) > Pc(r[0], r[1]) && (r[0] = i[0]))
            : o.push((r = i));
    ...
    (t.geoCentroid = function (t) {
      ...
      var n = pc,
        ...
        i = n * n + e * e + r * r;
      return i < eu &&
        ((n = lc), (e = hc), (r = dc), uc < nu && ((n = cc), (e = fc), (r = sc)), (i = n * n + e * e + r * r) < eu)
        ? [NaN, NaN]
        ...
        (b.clipExtent = function (t) {
          return arguments.length
            ? ((y =
                null == t
                  ? ((d = e = r = i = null), Yf)
                  : yf((d = +t[0][0]), (e = +t[0][1]), (r = +t[1][0]), (i = +t[1][1]))),
              _())
            : null == d
            ? null
            : [
    ...
    (t.interpolateCividis = function (t) {
      return (
        ...
        'rgb(' +
          Math.max(
            0,
            Math.min(255, Math.round(-4.54 - t * (35.34 - t * (2381.73 - t * (6402.7 - t * (7024.72 - 2710.57 * t))))))
          ) +
          ', ' +
          Math.max(
            0,
            Math.min(255, Math.round(32.49 + t * (170.73 + t * (52.82 - t * (131.46 - t * (176.58 - 67.37 * t))))))
          ) +
          ', ' +
          Math.max(
            0,
            Math.min(
              255,
              Math.round(81.24 + t * (442.36 - t * (2482.43 - t * (6167.24 - t * (6614.94 - 2475.67 * t)))))
            )
          ) +
          ')'
      );
    ...
    (t.interpolateRainbow = function (t) {
      ...
      return (ly.h = 360 * t - 100), (ly.s = 1.5 - 1.5 * n), (ly.l = 0.8 - 0.9 * n), ly + '';
    }),
      ...
      return (
        ...
        'rgb(' +
          Math.max(
            ...
            Math.min(
              255,
              Math.round(34.61 + t * (1172.33 - t * (10793.56 - t * (33300.12 - t * (38394.49 - 14825.05 * t)))))
            )
          ) +
          ', ' +
          Math.max(
            0,
            Math.min(255, Math.round(23.31 + t * (557.33 + t * (1225.33 - t * (3574.96 - t * (1073.77 + 707.56 * t))))))
          ) +
          ', ' +
          Math.max(
            0,
            Math.min(255, Math.round(27.2 + t * (3211.1 - t * (15327.97 - t * (27814 - t * (22569.18 - 6838.66 * t))))))
          ) +
          ')'
      );
    }),
    ...
    (t.ribbon = function () {
      ...
      function a() {
        ...
        if (
          ...
          o.moveTo(d, p),
          o.arc(0, 0, s, l, h),
          (l === g && h === y) || (o.quadraticCurveTo(0, 0, v * Ii(g), v * Hi(g)), o.arc(0, 0, v, g, y)),
    ...
    (t.scaleTime = function () {
      return Eh.apply(
        jv(Hd, Yd, Sd, Nd, wd, md, _d, pd, t.timeFormat).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]),
        arguments
      );
    }),
    (t.scaleUtc = function () {
      return Eh.apply(
        jv(pp, hp, Kd, Wd, Gd, Xd, _d, pd, t.utcFormat).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]),
        arguments
      );
    }),
    (t.scan = function (t, e) {
    ...
    (t.symbol = function () {
      ...
      function r() {
        var r;
        if ((e || (e = r = no()), t.apply(this, arguments).draw(e, +n.apply(this, arguments)), r))
        ...
        n.parent.A = (function (n, e, r) {
          if (e) {
            for (
              ...
              (c = fh(c)),
                ((a = sh(a)).a = n),
                (i = u.z + l - o.z - f + t(u._, o._)) > 0 && (lh(hh(u, n, r), n, i), (f += i), (s += i)),
                (l += u.m),
                (f += o.m),
                (h += c.m),
                (s += a.m);
    ...
    (t.zoom = function () {
      ...
      return (
        ...
        (g.translateExtent = function (t) {
          return arguments.length
            ? ((f[0][0] = +t[0][0]), (f[1][0] = +t[1][0]), (f[0][1] = +t[0][1]), (f[1][1] = +t[1][1]), g)
            : [
                [f[0][0], f[0][1]],
                [f[1][0], f[1][1]]
              ];
