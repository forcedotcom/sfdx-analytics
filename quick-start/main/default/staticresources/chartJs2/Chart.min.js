...
!(function (t, e) {
    ...
    w = {
      ...
      merge: function (t, e, n) {
        ...
        for (i = (n = n || {}).merger || w._merger, a = 0; a < u; ++a)
          if (((e = l[a]), w.isObject(e))) for (s = 0, o = (r = Object.keys(e)).length; s < o; ++s) i(r[s], t, e, n);
        return t;
      },
        ...
        (function (t, e, n, i) {
          ...
          for (
            i &&
              ...
              at(t, n),
              (n.endAngle = r),
              n.endAngle === n.startAngle && n.fullCircles && ((n.endAngle += it), n.fullCircles--)),
              t.beginPath(),
            ...
            t.stroke();
          for (
            t.beginPath(), t.arc(n.x, n.y, e.outerRadius, n.startAngle, n.startAngle + it), a = 0;
            a < n.fullCircles;
            ++a
          )
            t.stroke();
  ...
  z._set('global', {
    elements: {
      arc: { backgroundColor: z.global.defaultColor, borderColor: '#fff', borderWidth: 2, borderAlign: 'center' }
    }
  });
  var ot = X.extend({
      _type: 'arc',
        ...
        if (s.length) {
          ...
          for (
            ...
            (n = s[t]._view),
              ...
              n.skip ||
                ((d !== t - 1 && !o) || -1 === d ? r.moveTo(n.x, n.y) : V.canvas.lineTo(r, e._view, n), (d = t));
    ...
    var i,
      ...
      l = (function (t) {
        var e = t.borderSkipped,
          n = {};
        return e
          ? (t.horizontal ? t.base > t.x && (e = vt(e, 'left', 'right')) : t.base < t.y && (e = vt(e, 'bottom', 'top')),
            (n[e] = !0),
            n)
          : n;
      })(t);
  ...
  z._set('global', {
    elements: { rectangle: { backgroundColor: gt, borderColor: gt, borderSkipped: 'bottom', borderWidth: 0 } }
  });
  var yt = X.extend({
      _type: 'rectangle',
      draw: function () {
  ...
  function At(t, e, n) {
    var i,
      ...
      l = V.isNullOrUndef(r)
        ...
        : -1;
    return (
      V.isNullOrUndef(r) ? ((i = l * n.categoryPercentage), (a = n.barPercentage)) : ((i = r * o), (a = 1)),
  ...
  function qt(t) {
    var e, n, i, a;
    return (
      V.isObject(t) ? ((e = t.top), (n = t.right), (i = t.bottom), (a = t.left)) : (e = n = i = a = t),
          ...
          this._plugins.concat(a.plugins || []).forEach(function (t) {
            if (-1 === n.indexOf(t)) {
              var e = t.id,
                a = r[e];
              !1 !== a &&
                (!0 === a && (a = V.clone(z.global.plugins[e])), n.push(t), i.push({ plugin: t, options: a || {} }));
            }
          }),
          (e.descriptors = i),
          (e.id = this._cacheId),
  ...
  V.extend(Qe.prototype, {
    ...
    destroy: function () {
      ...
      i && (n.unbindEvents(), V.canvas.clear(n), Fe.releaseContext(n.ctx), (n.canvas = null), (n.ctx = null)),
        Le.notify(n, 'destroy'),
  ...
  function fn(t) {
    var e, n;
    return t.display
      ? ((e = V.options._parseFont(t)), (n = V.options.toPadding(t.padding)), e.lineHeight + n.height)
      : 0;
  }
  function gn(t, e) {
    return V.extend(
  ...
  var bn = X.extend({
    ...
    afterBuildTicks: function (t) {
      ...
      return on(t) && t.length
        ...
        : ((e.ticks = V.callback(e.options.afterBuildTicks, [e, e.ticks]) || e.ticks), t);
    },
    ...
    _getLabelSizes: function () {
      ...
      return (
        e ||
          ((t._labelSizes = e = hn(t.ctx, pn(t.options.ticks), t.getTicks(), t.longestTextCache)),
  ...
  var Dn = Sn.extend({
      ...
      _computeTickLimit: function () {
        ...
        return this.isHorizontal()
          ...
          : ((t = V.options._parseFont(this.options.ticks)), Math.ceil(this.height / t.lineHeight));
      },
  ...
  var Rn = xn.extend({
      ...
      handleTickRangeOptions: function () {
        ...
        (t.min = On(e.min, t.min)),
          ...
          t.min === t.max &&
            (0 !== t.min && null !== t.min
              ? ((t.min = Math.pow(10, Math.floor(Fn(t.min)) - 1)), (t.max = Math.pow(10, Math.floor(Fn(t.max)) + 1)))
              : ((t.min = 1), (t.max = 10))),
      ...
      getPixelForValue: function (t) {
        var e = this,
          n = 0;
        return (
          (t = +e.getRightValue(t)) > e.min && t > 0 && (n = (Fn(t) - e._startValue) / e._valueRange + e._valueOffset),
  ...
  function oi(t, e) {
    ...
    return (
      ...
      null !== o ? +o : (a || 'function' != typeof r || ((o = r(e)), V.isFinite(o) || (o = n.parse(o))), o)
    );
  }
  function si(t, e) {
  ...
  function li(t, e, n, i) {
    ...
    for (a = ei.indexOf(t); a < s - 1; ++a)
      if (((o = (r = ti[ei[a]]).steps ? r.steps : Qn), r.common && Math.ceil((n - e) / (o * r.size)) <= i))
        return ei[a];
    return ei[s - 1];
  }
  function ui(t, e, n) {
    ...
    for (t.beginPath(), o = 0, s = g; o < s; ++o)
      (d = n((u = e[(l = o % g)]._view), l, i)),
        ...
        h && c
          ...
          : b && x && (p ? (h && m.push(u), c && v.push(d)) : (yi(t, m, v, b, x), (b = x = 0), (m = []), (v = [])));
        ...
        for (i = 0; i < o; ++i)
          (r = null),
            (a = (n = t.getDatasetMeta(i)).dataset) &&
              ...
              (r = { visible: t.isDatasetVisible(i), fill: pi(a, i, o), chart: t, el: a }),
            (n.$filler = r),
            l.push(r);
        ...
        for (n = l.length - 1; n >= 0; --n)
          (e = l[n].$filler) &&
            ...
            o &&
              s &&
              r.length &&
              (V.canvas.clipArea(u, t.chartArea), _i(u, r, o, a, s, i._loop), V.canvas.unclipArea(u)));
      }
    },
  ...
  var Di = {
      ...
      beforeUpdate: function (t) {
        var e = t.options.legend,
          n = t.legend;
        e
          ? (V.mergeIf(e, z.global.legend), n ? (ge.configure(t, n, e), (n.options = e)) : Ai(t, e))
  ...
  var Ii = X.extend({
    ...
    fit: function () {
      var t,
        ...
        a = e.isHorizontal();
      n.display
        ? ((t = (V.isArray(n.text) ? n.text.length : 1) * V.options._parseFont(n).lineHeight + 2 * n.padding),
    ...
    zi = {
      ...
      beforeUpdate: function (t) {
        var e = t.options.title,
          n = t.titleBlock;
        e
          ? (V.mergeIf(e, z.global.title), n ? (ge.configure(t, n, e), (n.options = e)) : Fi(t, e))
